  ...
  const featuredBooks = [
    {
      ...
      description: "He died. Not by fate, not by accident, but as collateral in a hunt between beings beyond mortal comprehension. And yet... death was only the beginning. Chosen by a mysterious entity known only as Echo, a sarcastic soul from Earth...",
      rating: 4.8,
      chapters: 156,
      genre: "Fantasy"
    },
    {
      ...
      author: "Jade Phoenix",
      cover: "/api/placeholder/200/300",
      description: "In a world where power determines everything, Lin Wei discovers an ancient cultivation technique that could change his destiny forever. But with great power comes great danger...",
      rating: 4.6,
      chapters: 203,
      genre: "Cultivation"
    },
    {
      ...
      author: "Digital Sage",
      cover: "/api/placeholder/200/300",
      description: "When reality becomes a game and the game becomes reality, Alex must navigate through levels, quests, and boss battles to survive in this new world order...",
      rating: 4.9,
      chapters: 89,
      genre: "System"
    }
  ...
  const features = [
    {
      ...
      title: 'Read Novels',
      description: 'Discover thousands of captivating web novels across all genres. From cultivation to romance, fantasy to sci-fi.',
      bgColor: '#f0f8ff'
    },
    {
      icon: <EditOutlined style={{ fontSize: '48px', color: '#52c41a' }} />,
      title: 'Write Novels',
      description: 'Share your stories with the world. Our platform provides all the tools you need to publish and promote your work.',
      bgColor: '#f6ffed'
    },
    {
      icon: <TrophyOutlined style={{ fontSize: '48px', color: '#faad14' }} />,
      title: 'Earn Yuan/XP and Level Up',
      description: 'Earn rewards for reading, writing, and engaging with the community. Level up your profile and unlock exclusive features.',
      bgColor: '#fffbe6'
    }
  ];
            ...
            <Card style={{ borderRadius: '12px' }}>
              <Space direction="vertical" size="large" style={{ width: '100%' }}>
                <div>
                  ...
                  <Paragraph>
                    Why should you start your writing journey here at Yushan? 
                    Enjoy exclusive benefits, monetization options, and a supportive community.
                  </Paragraph>
          ...
          <Col xs={24} sm={20} md={16} lg={12} style={{ textAlign: 'center' }}>
            ...
            >
              ...
              <Paragraph style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '16px', marginBottom: '32px' }}>
                Join thousands of readers and writers in the Yushan community. 

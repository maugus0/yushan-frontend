            ...
            <div className="home-hero-carousel-wrapper">
              ...
              <Carousel autoplay dots={true} className="home-hero-carousel">
                {heroSlides.map((slide, idx) => (
                  <div key={idx}>
                    <div className="home-hero-slide" style={{ position: 'relative', justifyContent: 'flex-start' }}>
                      <div
                      ...
                      <div className="home-hero-slide-content home-hero-slide-content-left">
                        ...
                        <div className="home-hero-content">
                          <Title level={2} className="home-hero-title home-hero-title-white">{slide.title}</Title>
            ...
            <Col xs={24} sm={12} lg={8} key={index}>
              ...
              >
                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                  ...
                  <Paragraph className="home-feature-desc">
                    {feature.description}
                  </Paragraph>
